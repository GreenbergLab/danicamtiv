...
data <- read_mtrackj(folder = "motility/regulated-om",
...
fwrite(data_by_id, "motility/regulated-om/data-by-id-om.csv", sep = ",")
fwrite(data_norm, "motility/regulated-om/data-norm-om.csv", sep = ",")
fwrite(pca_lines, "motility/regulated-om/pca-lines-om.csv", sep = ",")
fwrite(pca_lines_norm, "motility/regulated-om/pca-lines-norm-om.csv", sep = ",")
