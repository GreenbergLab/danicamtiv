...
data <- read_mtrackj(folder = "motility/pCa-6.25-om-titration",
...
colorz <- c("#666666", alpha("#d95f02", 0.33), alpha("#d95f02", 0.66), "#d95f02")
...
ggsave("supplemental-figures/pCa-6.25-om-titration.pdf", bg = "white")
